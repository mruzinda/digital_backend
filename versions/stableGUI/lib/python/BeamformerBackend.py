...
#class BeamformerBackend(VegasBackend):
    ...
    * *unit_test:* Set to true to unit test. Will not attempt to talk to
    ...
    def prepare(self):
        ...
        self.set_status(BANKNAM=self.bank_name[-1])
    ...
    def start_hpc(self):
        ...
        self.hpc_process = subprocess.Popen(process_list,
                                            ...
                                            stdout=ThreadPrinter(printer_name=currentThread().name, dir_name=currentThread().dir)) # self.bank_name would also work
    ...
    def start_fits_writer(self):
        ...
        self.fits_writer_process = subprocess.Popen(process_list,
                                                    stdin=subprocess.PIPE,
                                                    stdout=ThreadPrinter(printer_name=self.bank_name, dir_name=currentThread().dir))
