...
if __name__ == '__main__':
    ...
    p.add_option('-c', '--set_coefficients', dest='set_coef', type='int', default=0,
                 help='Set the sideband separating coefficients.')
    p.add_option('-l', '--lo', dest='lo', type='str', default='1450',
                 help='Set the LO for sbs coefficients, default is 1450 MHz')
    p.add_option('-r', '--reset_transceivers', dest='reset_trans', type='int', default=0,
                 help='Reset data input transceivers.')
    p.add_option('-i', '--fft_shift', dest='fft_shift', type='long', default=0xaaaaaaaa,
                 help='Set the fft_shift register, default is 0xaaaaaaaa')
    p.add_option('-b', '--bit_lock', dest='auto_align_bits', type='int', default=0,
                 help='Automatically bit align the system')
    p.add_option('-B', '--byte_lock', dest='auto_align_bytes', type='int', default=0,
                 help='1=calc and align bytes, 2=check byte alignment')
    p.add_option('-e', '--byte_swap', dest='swap_bytes_ch', type='long', default=-1,
                 help='Swap bytes of specified channel')
    ...
    p.add_option('-s', '--get_sbs_data', dest='sbs_data', type='int', default=0,
                 help='Get sideband separated frequency data')
    p.add_option('-d', '--boffile', dest='bof', type='str', default=boffile, help='Specify the bof file to load')
    p.add_option('-p', '--packetizer', dest='pack', type='int', default=0,
                 help='Reset GbE cores, start GbE cores, Set f_id & x_id registers on firmware. Set destination port')
    ...
    p.add_option('-C', '--dcomp', dest='dcomp', type='str', default='blackhole',
                 help='The destination computer (paf0, tofu)')
    # Luke added
    ...
    lsbre01 = genfromtxt('./coefficients/' + opts.lo + '/' + fid_prefix + '_512_lsbre01_' + opts.lo + '.csv',
                         delimiter='/n')
    lsbre23 = genfromtxt('./coefficients/' + opts.lo + '/' + fid_prefix + '_512_lsbre23_' + opts.lo + '.csv',
                         delimiter='/n')
    lsbre45 = genfromtxt('./coefficients/' + opts.lo + '/' + fid_prefix + '_512_lsbre45_' + opts.lo + '.csv',
                         delimiter='/n')
    lsbre67 = genfromtxt('./coefficients/' + opts.lo + '/' + fid_prefix + '_512_lsbre67_' + opts.lo + '.csv',
                         delimiter='/n')

    lsbim01 = genfromtxt('./coefficients/' + opts.lo + '/' + fid_prefix + '_512_lsbim01_' + opts.lo + '.csv',
                         delimiter='/n')
    lsbim23 = genfromtxt('./coefficients/' + opts.lo + '/' + fid_prefix + '_512_lsbim23_' + opts.lo + '.csv',
                         delimiter='/n')
    lsbim45 = genfromtxt('./coefficients/' + opts.lo + '/' + fid_prefix + '_512_lsbim45_' + opts.lo + '.csv',
                         delimiter='/n')
    lsbim67 = genfromtxt('./coefficients/' + opts.lo + '/' + fid_prefix + '_512_lsbim67_' + opts.lo + '.csv',
                         delimiter='/n')

    usbre01 = genfromtxt('./coefficients/' + opts.lo + '/' + fid_prefix + '_512_usbre01_' + opts.lo + '.csv',
                         delimiter='/n')
    usbre23 = genfromtxt('./coefficients/' + opts.lo + '/' + fid_prefix + '_512_usbre23_' + opts.lo + '.csv',
                         delimiter='/n')
    usbre45 = genfromtxt('./coefficients/' + opts.lo + '/' + fid_prefix + '_512_usbre45_' + opts.lo + '.csv',
                         delimiter='/n')
    usbre67 = genfromtxt('./coefficients/' + opts.lo + '/' + fid_prefix + '_512_usbre67_' + opts.lo + '.csv',
                         delimiter='/n')

    usbim01 = genfromtxt('./coefficients/' + opts.lo + '/' + fid_prefix + '_512_usbim01_' + opts.lo + '.csv',
                         delimiter='/n')
    usbim23 = genfromtxt('./coefficients/' + opts.lo + '/' + fid_prefix + '_512_usbim23_' + opts.lo + '.csv',
                         delimiter='/n')
    usbim45 = genfromtxt('./coefficients/' + opts.lo + '/' + fid_prefix + '_512_usbim45_' + opts.lo + '.csv',
                         delimiter='/n')
    usbim67 = genfromtxt('./coefficients/' + opts.lo + '/' + fid_prefix + '_512_usbim67_' + opts.lo + '.csv',
                         delimiter='/n')

    mac_base0 = (2 << 40) + (2 << 32) + (10 << 24) + (17 << 16) + (16 << 8) + (
    4 * opts.fid + 230)  # give each physical port a unique id
...
try:
    ...
    fpga.write_int('fft_shift',
                   opts.fft_shift)  # Don't know where this number comes from but its like this in the tut3 example as well
    print 'done \n'
