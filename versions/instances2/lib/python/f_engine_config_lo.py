...
if __name__ == '__main__':
    ...
    lsbre01 = genfromtxt('/users/rblack/bf/dibas/lib/python/coefficients/'+opts.lo+'/'+fid_prefix+'_512_lsbre01_'+opts.lo+'.csv', delimiter = '/n')
    lsbre23 = genfromtxt('/users/rblack/bf/dibas/lib/python/coefficients/'+opts.lo+'/'+fid_prefix+'_512_lsbre23_'+opts.lo+'.csv', delimiter = '/n')
    lsbre45 = genfromtxt('/users/rblack/bf/dibas/lib/python/coefficients/'+opts.lo+'/'+fid_prefix+'_512_lsbre45_'+opts.lo+'.csv', delimiter = '/n')
    lsbre67 = genfromtxt('/users/rblack/bf/dibas/lib/python/coefficients/'+opts.lo+'/'+fid_prefix+'_512_lsbre67_'+opts.lo+'.csv', delimiter = '/n')
                                                  
    lsbim01 = genfromtxt('/users/rblack/bf/dibas/lib/python/coefficients/'+opts.lo+'/'+fid_prefix+'_512_lsbim01_'+opts.lo+'.csv', delimiter = '/n')
    lsbim23 = genfromtxt('/users/rblack/bf/dibas/lib/python/coefficients/'+opts.lo+'/'+fid_prefix+'_512_lsbim23_'+opts.lo+'.csv', delimiter = '/n')
    lsbim45 = genfromtxt('/users/rblack/bf/dibas/lib/python/coefficients/'+opts.lo+'/'+fid_prefix+'_512_lsbim45_'+opts.lo+'.csv', delimiter = '/n')
    lsbim67 = genfromtxt('/users/rblack/bf/dibas/lib/python/coefficients/'+opts.lo+'/'+fid_prefix+'_512_lsbim67_'+opts.lo+'.csv', delimiter = '/n')
                                                  
    usbre01 = genfromtxt('/users/rblack/bf/dibas/lib/python/coefficients/'+opts.lo+'/'+fid_prefix+'_512_usbre01_'+opts.lo+'.csv', delimiter = '/n')
    usbre23 = genfromtxt('/users/rblack/bf/dibas/lib/python/coefficients/'+opts.lo+'/'+fid_prefix+'_512_usbre23_'+opts.lo+'.csv', delimiter = '/n')
    usbre45 = genfromtxt('/users/rblack/bf/dibas/lib/python/coefficients/'+opts.lo+'/'+fid_prefix+'_512_usbre45_'+opts.lo+'.csv', delimiter = '/n')
    usbre67 = genfromtxt('/users/rblack/bf/dibas/lib/python/coefficients/'+opts.lo+'/'+fid_prefix+'_512_usbre67_'+opts.lo+'.csv', delimiter = '/n')
                                                  
    usbim01 = genfromtxt('/users/rblack/bf/dibas/lib/python/coefficients/'+opts.lo+'/'+fid_prefix+'_512_usbim01_'+opts.lo+'.csv', delimiter = '/n')
    usbim23 = genfromtxt('/users/rblack/bf/dibas/lib/python/coefficients/'+opts.lo+'/'+fid_prefix+'_512_usbim23_'+opts.lo+'.csv', delimiter = '/n')
    usbim45 = genfromtxt('/users/rblack/bf/dibas/lib/python/coefficients/'+opts.lo+'/'+fid_prefix+'_512_usbim45_'+opts.lo+'.csv', delimiter = '/n')
    usbim67 = genfromtxt('/users/rblack/bf/dibas/lib/python/coefficients/'+opts.lo+'/'+fid_prefix+'_512_usbim67_'+opts.lo+'.csv', delimiter = '/n')
